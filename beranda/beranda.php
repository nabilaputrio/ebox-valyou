    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <div class="navbar-nav ml-auto">
                ...
                <a class="nav-item nav-link active" href="../tentang/tentang.php">Tentang</a>
        ...
        <div class="container">
            <div class="row atas">
                <div class="col-lg-6 my-auto">
                    ...
                    <button type="button" class="btn btn-primary btn-lg " id="btnDaftar"><h4><strong>Daftar Sekarang</strong></h4></button>
                </div>
                <div class="col">
    ...
    <!-- Fitur Ebox-->
      <div class="container">
        ...
        <div class="row justify-content-center text-center" id="fitur">
          <div class="col-lg-2 col-md-3 col-sm-4 col-6">
            <img src="img/keamanan.png" alt="" width="110">
            <h6>Keamanan <br> stok barang</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4 col-6">
            <img src="img/statistika.png" alt="" width="110">
            <h6>Statistik <br> transaksi</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4 col-6">
            <img src="img/lokasi.png" alt="" width="110">
            <h6>Manajemen <br> lokasi</h6>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center" id="stok">
          <div class="col-lg-6 col-md-7 col-sm-12 mx-auto text-center">
            <img src="img/Group 67.png"  width="500" alt="" class="stok">
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Saya sangat suka dengan fitur melihat history stok masuk dan keluar sehingga memudahkan saya dalam membuat...</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Baru tau ada web dengan fitur se-keren ini, sayang sekali saya baru mengetauinya akhir tahun 2022 ini...</p>
              </div>
            </div>
          </div>
        </div>
