...
<div class="wrapper">
	...
	<nav id="sidebar">
		...
		<div class="dropdown" align="center">
			<button class="btn dropdown-toggle" style="background-color: #E9F1FC;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				...
				?>
					<a class="dropdown-item" href="../daftarLogin/pilihGudang.php?id=<?= $row['id_gudang']; ?>"> <strong> <?=$row['namaGudang']?> </strong> </a>
						...
						<div class="d-flex"  style="margin-bottom:30px">
							<div style="width:100%">
								...
								<div class="form-inline center-v" style="margin-bottom:10px">
									...
									<input type="number" id="harga_beli" name="harga_beli" required value="<?=$data['harga_beli']?>">
								</div>
								<div class="form-inline center-v">
									<label for="harga_jual">Harga jual</label>
									<input type="number" id="harga_jual" name="harga_jual" required value="<?=$data['harga_jual']?>">
								</div>
							</div>
						</div>
					</div>
					<div style="margin-left: 20px;" class="center-v input-photo">
						<input type="file" id="photo"  style="display:none;" onchange="readURL(this)" accept="image/*" name="photo" required>
						<label for="photo"><img src="image/produk/<?=$data['id']?>-<?=$data['photo']?>" id="image"></label>
						<script>
							$(function(){
