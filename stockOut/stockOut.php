...
<head>
	...
	<link rel="stylesheet" href="stockOut.css">
			...
			<div>
				<form method="POST" enctype="multipart/form-data">
					<div class="d-flex">
							...
							<div class="d-flex" style="margin-bottom:30px">
								<div style="width:100%">
											...
											<td>
												<div class="center-v">
													...
													<div style="margin-left: 20px;" class="left">
														<a style="font-size:14px;" class="m0"
															href="stockOut.php?id=<?= $data['id']; ?>">
															<?= $data['nama'] ?>
														</a>
													...
													<div class="right">
														...
														<p
															style="font-size:16px;color: red; margin-bottom: 0; float: right;">
															<?php if (isset($_POST['submit']) and $data['id'] === $id) {
		                                        echo "- " . $_POST['jumlah'];
	                                        } ?>
														</p>
													</div>
									...
									<div style="margin-top: 10%;">
										<button class="btnMasukkan" style="padding: 5px 25px; " name="submit"
											value="submit">
											<p style="font-size: 20px;color:white">Keluarkan</p>
										</button>
									</div>
								</div>
							</div>
						...
						<div style="margin-left: 20px;" class="center-v input-stok">
											...
											<div class="total">
												<p style="color: black;">
													<strong>
														...
														Jumlah Keluaran : <span style="color:red;">
